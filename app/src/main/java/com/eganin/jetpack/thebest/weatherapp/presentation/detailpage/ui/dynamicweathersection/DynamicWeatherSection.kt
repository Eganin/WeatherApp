...
import com.eganin.jetpack.thebest.weatherapp.presentation.detailpage.ui.precipitations.Particles
import com.eganin.jetpack.thebest.weatherapp.presentation.detailpage.ui.precipitations.particles.StepFrame
import com.eganin.jetpack.thebest.weatherapp.presentation.detailpage.ui.precipitations.particles.clouds.SceneCloud
import com.eganin.jetpack.thebest.weatherapp.presentation.detailpage.ui.precipitations.particles.rain.SceneRain
import com.eganin.jetpack.thebest.weatherapp.presentation.detailpage.ui.precipitations.snowParameters
import com.eganin.jetpack.thebest.weatherapp.presentation.ui.theme.*
...
fun DynamicWeatherLandscape(
    ...
    ConstraintLayout(
        ...
        Text(text = "${info.temperatureCelsius}",
            style = com.eganin.jetpack.thebest.weatherapp.presentation.ui.theme.Typography.h3,
            color = textColor,
            modifier = Modifier
                .statusBarsPadding()
        ...
        Text(text = "°C",
            style = com.eganin.jetpack.thebest.weatherapp.presentation.ui.theme.Typography.h5,
            color = textColor,
            modifier = Modifier
                .statusBarsPadding()
                .padding(top = 12.dp)
        ...
        Text(text = info.weatherType.weatherDesc,
            style = com.eganin.jetpack.thebest.weatherapp.presentation.ui.theme.Typography.h5.copy(shadow = textShadow),
            color = textColor,
